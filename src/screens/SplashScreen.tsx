  ...
  const mapLibreHtml = `
    ...
    <body>
        ...
        <script>
            ...
            // Calculates the shortest rotation difference (e.g. 350->10 is +20, not -340)
                ...
                try {
                    ...
                    vehicles.forEach(function(v) {
                        ...
                        if (markers[v.id]) {
                            ...
                            // --- FIX: NOISE & SHIVERING FILTER ---
                            // 1. Calculate distance (Euclidean approx is fine for small deltas)
                            ...
                            // 0.00002 ~= 2 meters (Ignore tiny GPS jitter)
                            // 0.00015 ~= 15 meters (Only rotate if moved significantly)
                            var POS_THRESHOLD = 0.00002;
                            var ROT_THRESHOLD = 0.00015;

                            if (dist > POS_THRESHOLD) {
                                var bearing;
                                // Only calculate new bearing if moved enough
                                // otherwise preserve old bearing to prevent "shivering"
